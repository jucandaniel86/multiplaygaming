...
<template>
  ...
  <div class="pa-4">
    ...
    <v-select :items="notificationDD" v-model="selectNotify" color="primary" variant="outlined" density="default"
  ...
  <perfect-scrollbar style="height: calc(100vh - 300px); max-height: 650px">
    <v-list class="py-0" lines="three">
      <v-list-item value="" color="secondary" class="no-spacer">
        ...
        <p class="text-subtitle-2 text-medium-emphasis mt-1">It is a long established fact that a reader will be
          distracted</p>
        <div class="mt-3">
      ...
      <v-list-item value="" color="secondary" class="no-spacer">
        ...
        <p class="text-subtitle-2 text-medium-emphasis mt-1">All done! Now check your inbox as you're in for a sweet
          treat!</p>
        <div class="mt-3">
      ...
      <v-list-item value="" color="secondary" class="no-spacer">
        ...
        <p class="text-subtitle-2 mt-1 text-medium-emphasis mb-3">It is a long established fact that a reader will be
          distracted</p>
