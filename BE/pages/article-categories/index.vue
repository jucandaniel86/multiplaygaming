  ...
  <v-row>
    <v-col cols="12">
      <div class="bg-light rounded h-100 p-4">
        <SharedPageHeader :title="'Article Categories'">
          <template v-slot:content>
            <button
              v-can="'articles_categories_add'"
        ...
        >
          ...
          <template v-slot:item="{ item }">
            <tr>
              ...
              <td class="custom-class">
                <button
                  v-can="'articles_categories_edit'"
                  type="button"
                ...
                <button
                  v-can="'articles_categories_delete'"
                  type="button"
  ...
  methods: {
    ...
    async getDataFromApi() {
      ...
      try {
        ...
        const { data } = await this.$axios.get("/article-categories/list", {
          params: {
            start: page,
            length: itemsPerPage,
